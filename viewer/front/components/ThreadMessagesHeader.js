...
const ThreadMessagesHeader = ({ channels, ims, currentChannelId, openSidebar }) => {
  ...
  return (
    <div className="messages-header">
      ...
      <div className="title">
        Thread in <ChannelName channel={channel} />
      </div>
    </div>
  );
};
...
export default connect(mapStateToProps, mapDispatchToProps)(ThreadMessagesHeader);
